...
public class TestConfig{
	...
	public static String from = "atul.trinyx@gmail.com";
	public static String password = "R@thod12196";
	public static String[] to ={"atrathod12194@gmail.com","atulrathod12194@gmail.com"};
